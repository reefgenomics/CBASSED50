...
head(ed50_df)
write.csv(ed50_df, "ed50_df.csv", row.names = FALSE)
```
...
ggsave("ed50_boxplot.pdf", ed50_boxplot, width = 16, height = 9)
ed50_boxplot
```
...
summary_ed50_df
write.csv(summary_ed50_df, "summary_ed50_df.csv", row.names = FALSE)
```
...
ggsave("tempresp_curve.pdf", tempresp_curve, width = 16, height = 9)
tempresp_curve
```
