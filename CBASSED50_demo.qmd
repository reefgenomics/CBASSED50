...
You need to execute this chunk only ones to get the `CBASSED50` package installed.
...
data("cbass_dataset")
output_prefix <- "examples/outputs/demo"
...
input_data_path <- selectFile(
  ...
  filter = "Data files (*.xls | *.xlsx | *.csv | *.txt)")

# Read data based on file format
cbass_dataset <- CBASSED50::read_data(input_data_path)
